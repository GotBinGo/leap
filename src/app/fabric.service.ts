...
class Particle {
  ...
  integrate = ( timesq ) => {
    ...
    newPos.multiplyScalar( 0.000001 ).add( this.position );
...
export class FabricService {
  ...
  this.bp(), this.bp(), this.bp(), this.bp(), this.bp(), this.bp()];

  ballSize = [60, 30, 30, 300, 300, 30, 30, 30, 30, 30, 30, 30];
  last = [[], [], [], [], [], [], [], [], [], [], [], []];
  ...
  simulate = (time) => {
    ...
    for ( particles = this.cloth.particles, i = 0, il = particles.length; i < il; i ++ ) {
      ...
      //particle.integrate( 18 / 1000 * 18 / 1000 );
