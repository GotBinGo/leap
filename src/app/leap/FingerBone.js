...
function FingerBone(fingerIndex, fromNodeIndex, toNodeIndex, mat) {
    ...
    this.bone = new THREE.Mesh(_getBoneGeometry(), mat);
    this.bone.castShadow = true;
    this.bone.receiveShadow = true;
    this.add(this.bone);

    this.node = new THREE.Mesh(_getNodeGeometry(), mat);
